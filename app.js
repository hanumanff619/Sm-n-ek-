// Směnářek 1.7 – bez UI jmenin, průsvitný kalendář, opravené výpočty, pozadí dle režimu
...
// Min. vestavěné jmeniny pro říjen/listopad (kvůli hlavičce)
...
let state = JSON.parse(localStorage.getItem('smenarek_state_v170')||'{}');
...
function save(){ localStorage.setItem('smenarek_state_v170', JSON.stringify(state)); }
