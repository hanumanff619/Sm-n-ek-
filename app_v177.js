// Směnářek 1.7.7 – vrácena sekce "Průměrná náhrada (poslední 3 měsíce)" + tmavý vzhled
...
let state = JSON.parse(localStorage.getItem('smenarek_state_v177')||'{}');
...
function save(){ localStorage.setItem('smenarek_state_v177', JSON.stringify(state)); }
...
function calcPay(){
  ...
  const holPay  = avg * C.holWorkedH;           // 11.25 h/den u 12h režimu
