...
let NAMEDAYS = {};
fetch('namedays_cs.json').then(r=>r.json()).then(j=>{ NAMEDAYS=j; updateToday(); }).catch(_=>{});
...
function renderMonth(){
  ...
  const monthName = d0.toLocaleDateString(S.lang, {month:'long', year:'numeric'});
